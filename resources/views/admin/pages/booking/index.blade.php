              ...
              <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $booking->user ? $booking->user->username : "-" }}</td>
                        ...
                        <td>
                          ...
                          @elseif($booking->status == 'Perpanjang Peminjaman')
                            <p class="badge text-bg-success">Perpanjang Peminjaman</p>
                        ...
                        <td class="d-flex flex-row align-items-start gap-1">
                          <a href="{{route('admin-booking.show',$booking->id)}}" class="btn btn-info">Proses Peminjaman</a>
                        </td>
                    </tr>
                    @endforeach
                  </tbody>

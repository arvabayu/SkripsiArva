              ...
              <div class="card-body">
                <form action="{{route('admin-booking.update',$booking->id)}}" method="post">
                  ...
                  <select class="form-select" id="category-select" name="status">
                    @if($booking->status == 'Diajukan' || $booking->status == 'Perpanjang Peminjaman')
                  ...
                  <button type="submit" id="submit-btn"  class="btn btn-info mt-2">Proses</button>
                </form>
              </div>
          </div>
      </div>
